-- Phase 1: Database Design (Supabase SQL)
-- Run this in Supabase SQL Editor to initialize or reset the database.
...
-- ==========================================
-- Seed Data: Mobile Friendly Defaults
-- ==========================================
...
('hero_banner_url', 'https://images.unsplash.com/photo-1556761175-5973dc0f32e7?auto=format&fit=crop&w=1600&q=80', 'appearance'),
('site_logo', 'Ekko.', 'appearance')
...
-- Admin User (Password: admin123 - Hashed with bcrypt cost 10)
-- $2b$10$5uXx.r0.1t.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x.x is just a placeholder. 
-- In a real scenario, you MUST generate a valid bcrypt hash for 'admin123'.
-- Ideally, use the registration API to create the first admin.
insert into users (email, password_hash, name, role, status) values
('admin@ekko.com', '$2b$10$r7.l.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z.z', 'Ekko Admin', 'admin', 'active')
on conflict (email) do nothing;

-- Sample Courses (Mobile Optimized Images)
